...
.toc-row {{ display: grid; grid-template-columns: 20mm 1fr 12mm; align-items: center; padding: 4.2pt 0; border-bottom: .45pt solid transparent; }}
.toc-row.toc-level-0 {{ padding-bottom: 6pt; border-bottom-color: var(--line); }}
